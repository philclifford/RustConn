...
1. Run `grep -rn 'ponytail:' --include='*.rs' rustconn-core/src rustconn-cli/src rustconn/src rustconn-pty-sys/src rustconn-locale-sys/src rustconn-env-sys/src` to find every intentional simplification marker.
